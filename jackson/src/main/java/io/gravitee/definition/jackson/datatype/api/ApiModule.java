...
import io.gravitee.definition.jackson.datatype.api.deser.endpoint.Http2EndpointDeserializer;
...
import io.gravitee.definition.jackson.datatype.api.ser.endpoint.Http2EndpointSerializer;
...
public class ApiModule extends GraviteeModule {
    ...
    public ApiModule() {
        ...
        addDeserializer(Http2Endpoint.class, new Http2EndpointDeserializer(Http2Endpoint.class));
        ...
        addSerializer(Http2Endpoint.class, new Http2EndpointSerializer(Http2Endpoint.class));
